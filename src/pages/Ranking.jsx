...
const Ranking = () => {
  ...
  const { liveIndex: dtLiveIndex, liveDetail: dtLiveDetail } = useDtPuntajes();
                ...
                {sortedDt.map((s, i) => {
                  ...
                  return (
                    <div key={s.uid}>
                      ...
                      {isOpen && <DtBreakdown squad={s} playersMap={dtPlayersMap} liveIndex={dtLiveIndex} liveDetail={dtLiveDetail} banked={s.bankedPoints || 0} />}
                    </div>
                  );
                })}
              </div>
